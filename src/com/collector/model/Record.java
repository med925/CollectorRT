...
public class Record {
	...
	public Record(Timestamp recordTime, Point coordinate, int speed, int power, boolean ignition, int mems_x,
			int mems_y, int mems_z, int sendFlag, int satInView, int signal, boolean validity,
                        int fmsFUel, int fmsTemp, double fmsOdo, int fmsCoso, int fmsRpm,double fmsTfu) {
		super();
		this.recordTime = recordTime;
		this.coordinate = coordinate;
		this.speed = speed;
    ...
    public String toString() {
        return "Record{" + "deviceId=" + deviceId + ", recordTime=" + recordTime + ", coordinate=" + coordinate + ", vertical=" + vertical + ", horizontal=" + horizontal + ", speed=" + speed + ", fuel=" + fuel + ", temperature=" + temperature + ", validity=" + validity + ", ignition=" + ignition + ", RealTimeRecordStatus=" + RealTimeRecordStatus + ", fmsFuel=" + fmsFuel + ", fmsTemp=" + fmsTemp + ", fmsRpm=" + fmsRpm + ", fmsConso=" + fmsConso + ", fmsOdo=" + fmsOdo + ", fmsTfu=" + fmsTfu + ", power=" + power + ", mems_x=" + mems_x + ", mems_y=" + mems_y + ", mems_z=" + mems_z + ", sendFlag=" + sendFlag + ", satInView=" + satInView + ", signal=" + signal + ", recordType=" + recordType + '}';
    }
